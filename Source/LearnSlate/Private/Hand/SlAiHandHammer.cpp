...
ASlAiHandHammer::ASlAiHandHammer()
{
	...
	//绑定模型到扩展模型组件
	static ConstructorHelpers::FObjectFinder<UStaticMesh> StaticExtendBaseMesh(TEXT("StaticMesh'/Game/Res/PolygonAdventure/Meshes/SM_Prop_StoneBlock_01.SM_Prop_StoneBlock_01'"));
	ExtendMesh->SetStaticMesh(StaticExtendBaseMesh.Object);
